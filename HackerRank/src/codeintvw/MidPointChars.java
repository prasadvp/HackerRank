...
public class MidPointChars {
   ...
   String[] words = document.split("[,. ]");
    ...
    for(String word : words) {
      ...
      if(word1Loc > 0 && word2Loc > 0) {
    	  //System.out.println("Word 1 location "+word1Loc +"  Word2 Location "+ word2Loc);
        double current = Math.abs(word1Loc - word2Loc);
    	  //double current = word1Loc - word2Loc;
  ...
  public static boolean doTestsPass() {
    ...
    return  //shortestDistance(_document, "layout", "It" ) == 6d
        shortestDistance(_document, "and", "graphic") == 6d &&
